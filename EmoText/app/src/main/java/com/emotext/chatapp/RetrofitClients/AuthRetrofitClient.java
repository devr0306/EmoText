package com.emotext.chatapp.RetrofitClients;

import com.emotext.chatapp.APIs.AuthAPI;
...
public class AuthRetrofitClient {
    ...
    private static final String BASE_URL = "http://134.209.28.184:5000/api/auth/";
